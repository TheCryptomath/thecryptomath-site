...
(function () {
  ...
  const I18N = {
    en: {
      ...
      primaryHorizonNote: "+24h is the primary public research window. +7d is retained as a secondary research follow-up. These are observations, not validated trading results. Results from small samples can vary widely and should not be interpreted as statistically meaningful.",
