...
(function () {
  ...
  const I18N = {
    en: {
      ...
      simFoot: (active) => `Simulation. 1 USDC allocated per detection, no leverage. ${active} still tracked. Current unrealized value only. Includes Watchlist, Signal and Exceptional detections.`,
    ...
    fr: {
      ...
      simFoot: (active) => `Simulation. 1 USDC alloué par détection, sans levier. ${active} encore suivies. Résultat actuel non clôturé. Inclut les détections Watchlist, Signal et Exceptional.`,
