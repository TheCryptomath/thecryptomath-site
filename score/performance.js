...
(function () {
  ...
  const I18N = {
    en: {
      ...
      simFoot: (active) => `Simulation. 1 USDC allocated per detection, no leverage. ${active} still tracked. Current unrealized value only.`,
    ...
    fr: {
      ...
      simFoot: (active) => `Simulation. 1 USDC alloué par détection, sans levier. ${active} encore suivies. Résultat actuel non clôturé.`,
