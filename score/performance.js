...
(function () {
  ...
  const I18N = {
    en: {
      ...
      simFoot: (active) => `Simulation. 1 USDC allocated per detection. ${active} still tracked. Current unrealized value only. Not realized PnL.`,
    ...
    fr: {
      ...
      simFoot: (active) => `Simulation. 1 USDC alloué par détection. ${active} encore suivies. Valeur latente actuelle uniquement. Pas un PnL réalisé.`,
