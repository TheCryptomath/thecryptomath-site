...
const SCORE_I18N = {
  en: {
    ...
    updated: "Updated.",
    autoDetectedSignals: "Auto detected <strong>{count} / 10</strong> criteria",
    ...
    downgradedDueToRR: "The result was adjusted because the optional execution plan failed an internal consistency check.",
    ...
    quickScanNoSignal: "Quick scan found no usable confluence.",
  ...
  fr: {
    ...
    updated: "Mis à jour.",
    autoDetectedSignals: "Détection automatique de <strong>{count} / 10</strong> critères",
    ...
    downgradedDueToRR: "Le résultat a été ajusté car le plan d’exécution optionnel n’a pas passé un contrôle interne de cohérence.",
    ...
    quickScanNoSignal: "Le scan rapide n’a trouvé aucune confluence exploitable.",
